    ...
    if (e is PlatformException) {
      switch (e.message) {
        case 'There is no user record corresponding to this identifier. The user may have been deleted.':
          return AppLocalizations.of(context).translate('NoUser');
          break;
        case 'The password is invalid or the user does not have a password.':
          return AppLocalizations.of(context).translate('InPassword');
          break;
        case 'A network error (such as timeout, interrupted connection or unreachable host) has occurred.':
          return AppLocalizations.of(context).translate('NoNet');
          break;
        case 'The email address is already in use by another account.':
          return AppLocalizations.of(context).translate('ToManyUsers');
        default:
