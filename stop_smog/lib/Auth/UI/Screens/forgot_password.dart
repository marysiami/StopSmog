  ...
  Widget build(BuildContext context) {
    ...
    final forgotPasswordButton = Padding(
      ...
      child: RaisedButton(
        ...
        child: Text(AppLocalizations.of(context).translate('ForgotPAssword'), style: TextStyle(color: Colors.white)),
      ),
    );
  ...
  void _forgotPassword({String email, BuildContext context}) async {
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        await _changeLoadingVisible();
        Flushbar(
          title: AppLocalizations.of(context).translate('ResetEmail'),
          message:
          AppLocalizations.of(context).translate('ResetMess'),
        ...
        Flushbar(
          title: AppLocalizations.of(context).translate('ForgotError'),
          message: exception,
